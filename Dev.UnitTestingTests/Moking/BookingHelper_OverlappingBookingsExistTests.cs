...
namespace Dev.UnitTestingTests.Moking
{
	...
	public class BookingHelper_OverlappingBookingsExistTests
	{
		...
		[Test]
		public void BookingStartsAndFinishesAfterAndExistingBooking_ReturnEmptyString()
		{
			var result = BookingHelper.OverlappingBookingsExist(new Booking
			{
				Id = 1,
		...
		private DateTime After(DateTime dateTime,  int days = 1) { return dateTime.AddDays(1); }
